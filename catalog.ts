...
export const ANTHROPIC_MODELS = [
  ...
  {
    id: "claude-opus-4.8",
    name: "Claude Opus 4.8 (OpenLimits)",
    reasoning: true,
    input: ["text", "image"],
    contextWindow: 1_000_000,
    maxTokens: 128_000,
  ...
  {
    id: "claude-opus-4.7",
    name: "Claude Opus 4.7 (OpenLimits)",
    reasoning: true,
    input: ["text", "image"],
    contextWindow: 1_000_000,
    maxTokens: 128_000,
  ...
  {
    id: "claude-sonnet-5",
    name: "Claude Sonnet 5 (OpenLimits)",
    reasoning: true,
    input: ["text", "image"],
    contextWindow: 1_000_000,
    maxTokens: 128_000,
  ...
  {
    id: "claude-haiku-4.5",
    name: "Claude Haiku 4.5 (OpenLimits)",
    reasoning: true,
    input: ["text", "image"],
...
export const RESPONSES_MODELS = [
  ...
  },
  {
    ...
    name: "GPT-5.3 Codex Spark (OpenLimits)",
    reasoning: true,
    input: ["text", "image"],
...
export const CHAT_MODELS = [
  {
    id: "z-ai/glm-5.2",
    name: "GLM 5.2 (OpenLimits)",
    reasoning: true,
    input: ["text"],
    contextWindow: 1_000_000,
    maxTokens: 128_000,
    cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
    thinkingLevelMap: { ...ZAI_TLM },
    compat: { ...ZAI_COMPAT },
  },
  {
    id: "z-ai/glm-5.1",
    name: "GLM 5.1 (OpenLimits)",
    reasoning: true,
    input: ["text"],
  ...
  },
  {
    ...
    name: "DeepSeek V4 Pro (OpenLimits)",
    reasoning: true,
    input: ["text"],
    contextWindow: 1_000_000,
    maxTokens: 384_000,
  ...
  },
  {
    ...
    name: "DeepSeek V4 Flash (OpenLimits)",
    reasoning: true,
    input: ["text"],
    contextWindow: 1_000_000,
    maxTokens: 384_000,
...
export const OPENLIMITS_CHAT_MODELS = [
  ...CHAT_MODELS,
  ...GPT_CHAT_MODELS,
] satisfies ProviderModelConfig[];
...
const FAMILY_DEFAULTS: Record<
  CatalogFamily,
  Omit<ProviderModelConfig, "id" | "name" | "cost">
> = {
  anthropic: {
    reasoning: true,
    input: ["text", "image"],
...
export function modelsForLiveIds(
  family: CatalogFamily,
  liveIds: string[],
): ProviderModelConfig[] {
  const staticModels: ProviderModelConfig[] =
    family === "anthropic"
      ? ANTHROPIC_MODELS
      : family === "responses"
        ? RESPONSES_MODELS
